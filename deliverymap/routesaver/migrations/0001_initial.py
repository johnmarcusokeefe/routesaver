# Generated by Django 3.0.7 on 2021-12-30 05:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='routesaver.Address')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True, null=True)),
                ('company', models.ManyToManyField(to='routesaver.Company')),
        ...
        migrations.AddField(
            model_name='company',
            name='images',
            field=models.ManyToManyField(to='routesaver.Image'),
        ),
    ]
